...
def _ensure_farming_capacity_raw_modifier_bridges(repo: Path, mod_root: Path) -> None:
    ...
    _write_farming_capacity_modifier_icons(
        mod_root,
        other_modifier=FARM_OTHER_BUILDINGS_CAPACITY_MODIFIER,
        building_modifiers={
    ...
    print(
        ...
        f"{len(fallback_building_keys)} non-blueprint building types.",
        flush=True,
    )
...
def _write_farming_capacity_modifier_icons(
    ...
    *,
    ...
    lines = [
        ...
        '\tnegative = "gfx/interface/icons/modifier_types/_default.dds"',
        "}",
        "",
    ]
...
def _write_farming_capacity_modifier_localization(
    ...
    *,
    ...
    lines = [
        ...
        f'  MODIFIER_TYPE_NAME_{other_modifier}: "Reduced Farming Capacity from [pp_buildings_in_location|e]"',
        f'  MODIFIER_TYPE_DESC_{other_modifier}: "Non-farm buildings in this location reduce Farming Capacity. Inspect farming building maximum levels for the active source breakdown."',
    ]
    for modifier_key, building in building_modifiers.items():
