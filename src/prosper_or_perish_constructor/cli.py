...
LOCATION_POTENTIAL_CONCEPT_LINES = (
    ...
    '  game_concept_pp_location_potential_desc: "Location Potential represents the number of people a location could support in a long-run local equilibrium using food systems and durable improvements available by 1337.\\n\\n#T Physical factors:#!\\n$BULLET$ Calibrated land area and latitude\\n$BULLET$ Topography, vegetation, soil, and climate\\n$BULLET$ Low-input crop yields for historically available cereals, rice, maize, roots, tubers, and tropical staples\\n$BULLET$ Fallow, seed, storage, processing, and harvest-risk reserves\\n$BULLET$ Pasture, livestock, fisheries, wild foods, and apiary products\\n$BULLET$ River, lake, irrigation, terrace, and coastal access\\n\\nFood imports are not counted. Starting population, historical population maps, the location RGO, and RGO output modifiers do not determine the value. The absolute estimate is converted to the displayed gameplay band only after the physical model is selected."',
