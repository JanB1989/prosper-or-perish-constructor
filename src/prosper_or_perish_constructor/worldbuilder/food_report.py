...
<h2>Import and export infrastructure</h2><p>Live caps include initialized navigation bonuses. Starting caps use the safe pre-initialization limit. Both market types transfer the same food per fully staffed level; operating imports are backed by exports within the estimated catchment. Every city has at least one import market; this minimum can initially be idle.</p><div class="scroll"><table><thead><tr><th>Location</th><th>Rank</th><th>Region</th><th>Import levels / live cap</th><th>Export levels / live cap</th><th>Development</th></tr></thead><tbody id="locations"></tbody></table></div>
