...
- Runtime: 3.7 seconds
- Runtime split: preparation 0.82s; simulation 2.80s
- Source cache: hit
- Modifier cache: hit
- Reproducible run hash: `64750627e0f8cb75`
- Locations: 20,929
...
| 25 | 1362 | 367.1m | 0.93× | — | — | 849.1m | 43.2% | 7.4 | — |
| 100 | 1437 | 289.4m | 0.73× | 0.97× | -24.4% | 849.4m | 34.1% | 7.7 | reference |
...
|---|---:|---:|---:|---:|---:|---:|---:|:---:|
| Europe | 100 | 52.3m | 0.68× | 0.73× | -7.1% | 29.3% | 12.2 | reference |
| North Africa | 100 | 10.4m | 0.76× | 0.92× | -17.0% | 43.3% | 7.0 | PASS |
| West Africa | 100 | 9.2m | 0.89× | 1.12× | -20.6% | 37.0% | 4.9 | PASS |
...
| Near East | 100 | 12.0m | 0.72× | 0.85× | -15.3% | 30.7% | 11.8 | PASS |
| Central Asia | 100 | 2.2m | 0.71× | 1.09× | -34.1% | 14.3% | 4.7 | FAIL |
| South Asia | 100 | 67.9m | 0.69× | 1.04× | -34.0% | 60.3% | 9.9 | FAIL |
| East Asia | 100 | 73.1m | 0.70× | 0.93× | -24.8% | 49.0% | 10.7 | PASS |
...
| Mesoamerica | 100 | 11.8m | 0.90× | 1.10× | -18.3% | 37.9% | 7.3 | PASS |
| Caribbean | 100 | 133.2k | 1.00× | 1.44× | -30.7% | 2.8% | 1.3 | FAIL |
| Andes | 100 | 7.7m | 0.95× | 1.06× | -10.3% | 56.2% | 5.5 | PASS |
...
Review artifacts:
- Locations: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum.parquet`
- Macro Regions: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum_macro_regions.csv`
- Province Statistics: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum_province_statistics.csv`
- Province Totals: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum_province_totals.csv`
- Location Rankings: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum_location_rankings.csv`
- Tracked Provinces: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum_tracked_provinces.csv`
- Summary: `/home/jan/development/ProsperOrPerishConstructor/tmp/population_capacity_design_review/baseline_maximum_summary.json`
...
| 3812 | motu_maha_province | australasia | 0.00 | 6.93 | 0.00 | 0.00 | 7.00 | 0.000× |
...
| 3783 | vorkuta_province | eastern_europe | 7.11 | 20.78 | 0.00 | 0.00 | 21.00 | 0.339× |
...
| 3309 | south_ktunaxa_province | north_america | 1.91 | 63.53 | 0.00 | 0.00 | 65.00 | 0.029× |
| 3641 | malemiut_province | north_america | 1.05 | 39.11 | 0.00 | 0.00 | 40.00 | 0.026× |
